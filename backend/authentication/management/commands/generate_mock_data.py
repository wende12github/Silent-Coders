...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        uniqname = random.randint(1000, 9999)  # To be Ensure username/email uniqueness using random methods
        ...
        for i in range(10):
            ...
            # Here Leaderboard stats Generate
        ...
        # Groups and Chat message creations
        for i in range(3):
