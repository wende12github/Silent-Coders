        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg">
              Teach what you know, learn what you need – no money required.
            </p>
            <div className="flex justify-center md:justify-start gap-8">
              <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-[white] font-medium rounded-[var(--radius)] px-6 py-2 text-lg">Get Started</button>
              <a href='#about-us'><button className="transition duration-200 border-1 rounded-[var(--radius)] text-[var(--color-primary)] font-medium px-6 py-2 text-lg hover:bg-[var(--color-muted)]">Learn More</button></a>
            </div>
          </div>
