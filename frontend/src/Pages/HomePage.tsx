...
import { Search, Calendar, Clock, Filter, MapPin } from 'lucide-react';
...
const mockSkills = [
  {
    ...
    description: 'Front-end web development with a focus on React and modern JavaScript',
    type: 'offering',
    credits: 3,
    location: 'Remote',
  ...
  },
  {
    ...
    description: 'Beginner to intermediate yoga lessons focusing on proper form and mindfulness',
    type: 'offering',
    credits: 2,
    location: 'Local',
  ...
  },
  {
    ...
    description: 'Acoustic and electric guitar instruction for beginners, focus on basic chords and melodies',
    type: 'offering',
    credits: 2,
    location: 'Local',
  ...
  },
  {
    ...
    description: 'Logo design, branding materials, and digital illustrations for personal or small business use',
    type: 'offering',
    credits: 4,
    location: 'Remote',
  ...
  },
  {
    ...
    description: 'Conversational Spanish lessons for beginners, focus on practical vocabulary and grammar',
    type: 'seeking',
    credits: 2,
    location: 'Remote',
  ...
  },
  {
    ...
    description: 'Learn composition, lighting, and basic editing techniques for digital photography',
    type: 'seeking',
    credits: 3,
    location: 'Local',
...
const HomePage = () => {
  ...
  const filteredSkills = mockSkills.filter(skill => {
    ...
    // Filter by location
    if (locationFilter !== 'all' && skill.location.toLowerCase() !== locationFilter) {
      return false;
    }
